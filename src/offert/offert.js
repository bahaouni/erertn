        ...
        <div className='container'>
            ...
            <div className="sous">
                ...
                <div className="des">
                    ...
                    <textarea name="description" id="description" placeholder="describe your house"></textarea>
                </div>
                



                <div className="gov"><label htlmFor="governorate"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                ...
                <div className="loc"><label htlmFor="location"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                </svg>location</label>
                ...
                <div className="pri"><label htlmFor="price"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-cash-coin" viewBox="0 0 16 16">
                ...
                <div className="num"><label htlmFor="num"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-telephone-fill" viewBox="0 0 16 16">
